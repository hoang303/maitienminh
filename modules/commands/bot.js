...
❎ 𝐓𝐮𝐨̂̉𝐢: 𝟭4
👤 𝐆𝐢𝐨̛́𝐢 𝐓𝐢́𝐧𝐡: 𝗡ữ
💫 𝐂𝐡𝐢𝐞̂̀𝐮 𝐜𝐚𝐨 𝐜𝐚̂𝐧 𝐧𝐚̣̆𝐧𝐠: 1𝗺?? 𝘅 ??𝗸𝗴
💘 𝐌𝐨̂́𝐢 𝐪𝐮𝐚𝐧 𝐡𝐞̣̂: Chưa xác định
🌎 𝐐𝐮𝐞̂ 𝐪𝐮𝐚́𝐧: Miền Bắc
👫 𝐆𝐮: 𝗕𝗶𝗲̂́𝘁 𝗹𝗮̀𝗺 𝘃𝗶𝗲̣̂𝗰 𝗻𝗵𝗮̀, 𝗻𝗴𝗼𝗮𝗻 𝗻𝗴𝗼𝗮̃𝗻 𝗵𝗶𝗲̂̀𝗻 𝗹𝗮̀𝗻𝗵
🌸 𝐓𝐢́𝐧𝐡 𝐜𝐚́𝐜𝐡: 𝗛𝗶𝗲̂̀𝗻 𝗹𝗮̀𝗻𝗵
🌀 𝐒𝐨̛̉ 𝐭𝐡𝐢́𝐜𝐡: 𝗖𝗵𝗼̛𝗶 𝗴𝗮𝗺𝗲, 𝗻𝗵𝗮̆́𝗻 𝘁𝗶𝗻, săn hàng giảm giá
💻𝐂𝐨𝐧𝐭𝐚𝐜𝐭💻
☎ 𝗦𝗗𝗧 & 𝗭𝗮𝗹𝗼: 𝟬987.654.321
🌐 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤: https://www.facebook.com/100070486773916 🌺`,
...
fs.createWriteStream(__dirname+'/cache/1.png')).on('close',() => callback());
   ...
   const listAdmin = global.config.ADMINBOT[0];
    if (senderID != listAdmin) return api.sendMessage("Bạn vui lòng đi ra chỗ khác 𝗻𝗵𝗮𝗻𝗵, không được phá bot 👊", threadID, messageID);
...
return api.sendMessage("𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐫𝐞𝐥𝐨𝐚𝐝𝐞𝐝 𝐜𝐨𝐧𝐟𝐢𝐠.𝐣𝐬𝐨𝐧", event.threadID, event.messageID);    
          ...
          /// admin only ///
        case "5": {
          if (event.senderID != 100048121433546) return api.sendMessage(`» Bạn chưa đủ tuổi để xài , xin cảm ơn 😏`, event.threadID, event.messageID)
