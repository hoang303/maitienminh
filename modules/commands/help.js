module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "ỐC BƯU", // fix by BAO CÔNG
...
module.exports.run = function({ api, event, args }) {
    ...
    const prefix = (threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : global.config.PREFIX;
  var tl = ["𝐀𝐝𝐦𝐢𝐧 𝐜𝐮𝐭𝐞 𝐡𝐨̛𝐧 𝐛𝐚̣𝐧","𝐂𝐨𝐧 𝐛𝐨𝐭 𝐜𝐮𝐭𝐞 𝐡𝐨̛𝐧 𝐛𝐚̣𝐧","𝐒𝐩𝐚𝐦 𝐛𝐨𝐭 𝐥𝐚̀ 𝐚̆𝐧 𝐛𝐚𝐧 𝐯𝐢̃𝐧𝐡 𝐯𝐢𝐞̂̃𝐧","𝐁𝐨𝐭 𝐢𝐮 𝐛𝐚̣𝐧 𝐯𝐜𝐥 𝐥𝐮𝐨̂𝐧","𝐀𝐝𝐦𝐢𝐧 𝐃𝐞𝐩 𝐒𝟏𝐓𝐆","𝐒𝐮̛̃𝐚 𝐯𝐢𝐧𝐚𝐦𝐢𝐥𝐤 𝐥𝐚̀𝐦 𝐭𝐮̛̀ 𝐬𝐮̛̃𝐚","𝐀𝐝𝐦𝐢𝐧 𝐫𝐚̂́𝐭 𝐯𝐮𝐢 𝐭𝐢́𝐧𝐡 𝐜𝐨́ 𝐥𝐮́𝐜 𝐤𝐡𝐨̂𝐧𝐠 𝐯𝐮𝐢","𝐓𝐢𝐞̂̀𝐧 𝐥𝐚̀ 𝐠𝐢𝐚̂́𝐲","𝐗𝐚̀𝐢 𝐟𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐪𝐮𝐚́ 𝟏𝟖𝟎𝐩 𝐬𝐞̃ 𝐤𝐡𝐢𝐞̂́𝐧 𝐛𝐚̣𝐧 𝐞̂́","𝐋𝐮̛𝐨̛́𝐭 𝐭𝐢𝐤𝐭𝐨𝐤 𝐪𝐮𝐚́ 𝟏𝟖𝟎𝐩 𝐬𝐞̃ 𝐛𝐢̣ 𝐚̉𝐨","27-10 𝐥𝐚̀ 𝐬𝐢𝐧𝐡 𝐧𝐡𝐚̣̂𝐭 𝐜𝐮̉𝐚 𝐀𝐝𝐦𝐢𝐧 Ốc Bưu","𝐂𝐨𝐧 𝐭𝐡𝐨̉ 𝐜𝐡𝐚̣𝐲 𝐫𝐚̂́𝐭 𝐧𝐡𝐚𝐧𝐡","𝐌𝐚̣̆𝐭 𝐭𝐫𝐚̆𝐧𝐠 𝐡𝐢̀𝐧𝐡 𝐯𝐮𝐨̂𝐧𝐠","𝐂𝐡𝐨̛𝐢 𝐠𝐚́𝐢 𝐝𝐮̛𝐨̛́𝐢 𝟏𝟖 𝐭𝐮𝐨̂̉𝐢 𝐫𝐚̂́𝐭 𝐥𝐚̂𝐮 𝐫𝐚","𝐁𝐚̣𝐧 𝐫𝐚̂́𝐭 𝐱𝐢𝐧𝐡 𝐠𝐚́𝐢","𝐌𝐢̀𝐧𝐡 𝐥𝐚̀ 𝐁𝐨𝐭 của Ốc","Máy 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐧𝐡𝐨̉ 𝐯𝐜𝐥","Bộ nhớ 𝐛𝐚̣𝐧 𝐪𝐮𝐚́ 𝐛𝐞́","𝐍𝐠𝐮̛𝐨̛̀𝐢 𝐜𝐡𝐚̣𝐲 𝐛𝐨𝐭 𝐫𝐚̂́𝐭 𝐝𝐞̂̃ 𝐭𝐡𝐮̛𝐨̛𝐧𝐠","Săn mã giảm giá rất 𝐭𝐨̂́𝐭 𝐜𝐡𝐨 𝐬𝐮̛́𝐜 𝐤𝐡𝐨𝐞̉"];
